...
public class AboutWindow extends ScrollableTowerWindow {
  public AboutWindow(Stage stage) {
    ...
    defaults().left().space(Display.scale(8));

    row().padTop(Display.scale(20));
    ...
    addLabel("Programming and Game Design", FontManager.Roboto18).spaceBottom(Display.scale(16));
    ...
    add(willPhillipsButton).spaceBottom(Display.scale(16));

    addLabel("Alex Miller", FontManager.Roboto24);
    addLabel("Lead Artist", FontManager.Roboto18).spaceBottom(Display.scale(32));
    ...
    addHorizontalRule(Colors.DARK_GRAY, 1, 1).padTop(Display.scale(50));
    ...
    try {
      ...
      for (String licenseFile : licenseFiles) {
        ...
        if (licenseFileHandle.exists()) {
          addLabel(licenseFileHandle.readString(), FontManager.Roboto18).spaceBottom(Display.scale(32));
        }
      }
