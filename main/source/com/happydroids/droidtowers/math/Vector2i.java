...
public class Vector2i implements Serializable {
   ...
   * @see #tmp() *
   */
  public final static Vector2i tmp = new Vector2i();
   ...
   * @return this vector
   */
  public Vector2i mul(Matrix3 mat) {
   ...
   * @return This vector for chaining.
   */
  public Vector2i lerp(Vector2i target, int alpha) {
    Vector2i r = this.mul(1 - alpha);
   ...
   */
  public boolean epsilonEquals(Vector2i obj, int epsilon) {
