...
public class TowerAssetManagerFilesList {
  ...
  static {
    ...
    files.put("swatches/swatch-ff00ff00.png", Texture.class);
    ...
    preloadFiles.put("hud/horizontal-rule.png", Texture.class);
    ...
    files.put("swatches/swatch-ffff0000.png", Texture.class);
    files.put("fonts/roboto_white_32.fnt", BitmapFont.class);
    files.put("fonts/bank_gothic_64.fnt", BitmapFont.class);
    files.put("swatches/swatch-ff993f7f.png", Texture.class);
