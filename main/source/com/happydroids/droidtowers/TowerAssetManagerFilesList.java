...
public class TowerAssetManagerFilesList {
  ...
  static {
    ...
    files.put("fonts/roboto_white_18.fnt", BitmapFont.class);
    preloadFiles.put("hud/buttons.txt", TextureAtlas.class);
    preloadFiles.put("swatches/swatch-ff993f7f.png", Texture.class);
    files.put("sound/effects/click.wav", Sound.class);
    files.put("backgrounds/ground-top.png", Texture.class);
    files.put("hud/star-white.png", Texture.class);
    preloadFiles.put("swatches/swatch-ff0000ff.png", Texture.class);
    ...
    files.put("hud/status-bar-bg.png", Texture.class);
    ...
    preloadFiles.put("swatches/swatch-ff00ff00.png", Texture.class);
    ...
    preloadFiles.put("happy-droid.png", Texture.class);
    ...
    preloadFiles.put("swatches/swatch-white.png", Texture.class);
    preloadFiles.put("swatches/swatch-ffff0000.png", Texture.class);
