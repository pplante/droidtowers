...
import org.apach3.commons.logging.impl.NoOpLog;
 ...
 *     <code>org.apach3.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 *
 * <p>You can change the default behavior in one of two ways:</p>
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>org.apach3.commons.logging.log</code> to the name of the
 *     <code>org.apach3.commons.logging.Log</code> implementation class
 *     you want to use.</li>
...
public class LogSource {
    ...
    static {
        ...
        // Is Log4J Available?
        try {
            if (null != Class.forName("org.apach3.log4j.Logger")) {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("org.apach3.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("org.apach3.commons.logging.log");
            if (name == null) {
                name = System.getProperty("org.apach3.commons.logging.Log");
            }
        } catch (Throwable t) {
            ...
            try {
                ...
                try {
                    setLogImplementation
                            ("org.apach3.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
     ...
     * <tt>org.apach3.commons.logging.log</tt> property.
     * The value of <tt>org.apach3.commons.logging.log</tt> may be set to
     ...
     * <p>
     * When <tt>org.apach3.commons.logging.log</tt> is not set,
