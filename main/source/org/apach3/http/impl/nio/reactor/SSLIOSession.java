 ...
 * @since 4.0
 *
 * @deprecated (4.2) use {@link org.apach3.http.nio.reactor.ssl.SSLIOSession}
 */
@Deprecated
public class SSLIOSession extends org.apach3.http.nio.reactor.ssl.SSLIOSession {
    ...
    public SSLIOSession(
        ...
        super(session, org.apach3.http.nio.reactor.ssl.SSLMode.CLIENT,
    ...
    public synchronized void bind(
        ...
        org.apach3.http.nio.reactor.ssl.SSLSetupHandler handler = getSSLSetupHandler();
    ...
    private org.apach3.http.nio.reactor.ssl.SSLMode convert(final SSLMode mode) {
        switch(mode) {
        case CLIENT:
            return org.apach3.http.nio.reactor.ssl.SSLMode.CLIENT;
        case SERVER:
            return org.apach3.http.nio.reactor.ssl.SSLMode.SERVER;
        }
        return null;
    }
