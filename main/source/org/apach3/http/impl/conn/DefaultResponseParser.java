 ...
 *  <li>{@link org.apach3.http.conn.params.ConnConnectionPNames#MAX_STATUS_LINE_GARBAGE}</li>
 * </ul>
 *
 * @since 4.0
 *
...
public class DefaultResponseParser extends AbstractMessageParser<HttpMessage> {
    ...
    protected int getMaxGarbageLines(final HttpParams params) {
        return params.getIntParameter(
                org.apach3.http.conn.params.ConnConnectionPNames.MAX_STATUS_LINE_GARBAGE,
                Integer.MAX_VALUE);
    }
