 ...
 *
 */
package org.apach3.http.client.cache;

/**
 * This enumeration represents the various ways a response can be generated
 * by the {@link org.apach3.http.impl.client.cache.CachingHttpClient};
 * if a request is executed with an {@link org.apach3.http.protocol.HttpContext}
 * then a parameter with one of these values will be registered in the
 * context under the key
 * {@link org.apach3.http.impl.client.cache.CachingHttpClient#CACHE_RESPONSE_STATUS}.
 */
