...
public class AppBundleProperties {
  ...
  private String customPListFile;
  ...
  public String getCustomPListFile() {
    return customPListFile;
  }

  public void setCustomPListFile(String customPListString) {
    this.customPListFile = customPListString;
  }
}
